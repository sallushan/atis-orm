...
namespace Atis.SqlExpressionEngine.UnitTest.Metadata
{
    ...
    public abstract class EntityRelation<TParent, TChild> : IEntityRelation<TParent, TChild>
    {
        ...
        public virtual Expression<Func<TParent, IQueryable<TChild>>>? FromParentToChild() => null;
        public virtual Expression<Func<TChild, IQueryable<TParent>>>? FromChildToParent() => null;
